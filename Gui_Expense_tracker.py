...
class ConfirmDialog:
    ...
    def __init__(self, root, title, message, confirm_text="Confirm",
        ...
        # Make sure the popup is actually drawn on screen before grabbing
        # input. Grabbing too early (before the window exists visibly) is
        # what was causing the app to freeze on Delete.
        overlay.update()
        overlay.lift()
        overlay.focus_force()
        overlay.grab_set()
        ...
        # The popup stole OS-level keyboard focus via focus_force(); without
        # explicitly handing it back, typing in other pages (e.g. Budget)
        # can appear "stuck" after this dialog closes.
        root.lift()
        root.focus_force()
